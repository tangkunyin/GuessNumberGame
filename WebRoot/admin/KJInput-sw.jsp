...
#snum{ width:66px; height: 30px; text-align:center; font-size:21px; font-weight: bold; color: red; }
...
<div id="mainBox">
    ...
    <div id="main">
      <div id="screen">请输入十位数：</div>
   	  <p><input name="num" id="snum" maxlength="1">&nbsp;&nbsp;<input type="button" value="完成" id="swsubbt"/></p>
    </div>
    <div id="previous">
		  <a id="preButt">上一步</a>
  	</div>
